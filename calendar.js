...
var dayArray = [];
  for(var i = 0; i< allOfDays.length; i++){
      if(i === 6 || i === 13 || i === 20 || i === 27 || i === 34){
        ...
        allOfDays[i].outerHTML += '<div class="day-details"><div id="input-arrow"></div><div class="input"><h2>JANUARY 10 , 2020</h2><div class="row"><div class="col-lg-12 timedtl"><p>Haircut</p><p>10:00 AM - 12:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>12:00 PM - 2:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>3:00 PM - 5:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>5:00 PM - 7:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>7:00 PM - 9:00 PM</p><p>Available</p></div></div></div></div>'
      }
    }  
  document.getElementById(id).innerHTML += '<div class="day-details"><div id="input-arrow"></div><div class="input"><h2>JANUARY 10 , 2020</h2><div class="row"><div class="col-lg-12 timedtl"><p>Haircut</p><p>10:00 AM - 12:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>12:00 PM - 2:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>3:00 PM - 5:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>5:00 PM - 7:00 PM</p><p>Available</p></div><div class="col-lg-12 timedtl"><p>Haircut</p><p>7:00 PM - 9:00 PM</p><p>Available</p></div></div></div><div style="clear:both"></div>';

$('.timedtl').click(function(event){
        $('#after_pop').css('display','block');
      });

$('.abc').click(function(event){
        $('#after_pop').css('display','none');
      });
}
